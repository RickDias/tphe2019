...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Melhorias sugeridas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<?php
				...
				$sql = mysqli_query($cx, "SELECT `ID_MELHORIA`, `DESCRICAO`, `DT_SOLICITACAO`, `DT_ATUALIZACAO`, `SITUACAO`, `ID_USUARIO` 
											FROM `melhorias` 
                                ...
                                <tbody>
									<?php
										...
										//pecorrendo os registros da consulta.
											...
											echo '<td>'.$aux['ID_MELHORIA'].'</td>'; 
											echo '<td>'.$aux['DESCRICAO'].'</td>';
											echo '<td>'.$aux['DT_SOLICITACAO'].'</td>';	
											echo '<td>'.$aux['DT_ATUALIZACAO'].'</td>'; 
											echo '<td>';
											if ($aux['SITUACAO'] == 'S') 
												echo 'Solicitado';
											else $aux['SITUACAO'].'</td>';
											echo '</tr>'; // fecha linha
