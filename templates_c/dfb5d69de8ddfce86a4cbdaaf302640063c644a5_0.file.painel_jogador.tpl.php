...
<!-- jQuery -->
<!-- lined-icons -->
<link rel="stylesheet" href="theme/default/css/icon-font.min.css" type='text/css' />
<!-- //lined-icons -->
...
<!--// webfonts -->
 <!-- Meters graphs -->
<?php echo '<script'; ?>
 src="theme/default/js/jquery-1.11.1.min.js"><?php echo '</script'; ?>
>
<!-- Placed js at the end of the document so the pages load faster -->
</head>
<!-- relogio, ajustar -->
<!-- <div class="clock-bottom" style="float:right;margin-left:15px;background:black;">
  <div class="clock">
    <div id="Date"></div>
    <ul>
      <li id="hours"> </li>
...
>
      ...
      <!-- main content end-->
	<?php echo '<script'; ?>
 src="theme/default/js/modernizr.custom.js"><?php echo '</script'; ?>
>
	<!--pop-up-->
	<?php echo '<script'; ?>
 src="theme/default/js/menu_jquery.js"><?php echo '</script'; ?>
>
	<!--//pop-up-->
	<?php echo '<script'; ?>
 src="theme/default/js/jquery.nicescroll.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 src="theme/default/js/scripts.js"><?php echo '</script'; ?>
>
	<!-- Bootstrap Core JavaScript -->
	<?php echo '<script'; ?>
 src="theme/default/js/bootstrap.min.js"><?php echo '</script'; ?>
>
	<!--pop-up-->
	<?php echo '<script'; ?>
 src="theme/default/js/menu_jquery.js"><?php echo '</script'; ?>
...
>
	...
	<!-- ResponsiveTabs -->
	<?php echo '<script'; ?>
 src="theme/default/js/easyResponsiveTabs.js" type="text/javascript"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript">
		$(document).ready(function () {
...
>
	...
	<!-- video -->
	<?php echo '<script'; ?>
 src="theme/default/js/simplePlayer.js"><?php echo '</script'; ?>
>
