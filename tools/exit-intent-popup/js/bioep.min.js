window.bioEp = {
    ...
    cookieManager: {
        create: function(a, b, d) {
            var c = "";
            d && (c = new Date, c.setTime(c.getTime() + 864E5 * d), c = "; expires=" + c.toGMTString());
        ...
        get: function(a) {
            ...
            for (var b = document.cookie.split(";"), d = 0; d < b.length; d++) {
                ...
                if (0 === c.indexOf(a)) return c.substring(a.length,
                    c.length)
            }
            return null
        },
    ...
    checkCookie: function() {
        if (0 >= this.cookieExp) return this.cookieManager.erase("bioep_shown"), !1;
        if ("true" == this.cookieManager.get("bioep_shown")) return !0;
    ...
    addCSS: function() {
        ...
        a = document.createTextNode("#bio_ep_bg {display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: #000; opacity: 0.7; z-index: 10001;}#bio_ep {display: none; position: fixed; width: " +
            this.width + "px; height: " + this.height + "px; font-family: 'Titillium Web', sans-serif; font-size: 16px; left: 50%; top: 50%; transform: translateX(-50%) translateY(-50%); -webkit-transform: translateX(-50%) translateY(-50%); -ms-transform: translateX(-50%) translateY(-50%); background-color: #fff; box-shadow: 0px 1px 4px 0 rgba(0,0,0,0.5); z-index: 10002;}#bio_ep_close {position: absolute; left: 100%; margin: -8px 0 0 -12px; width: 20px; height: 18px; color: #fff; padding-top:2px; font-size: 12px; font-weight: bold; text-align: center; border-radius: 50%; background-color: #5c5c5c; cursor: pointer;}" +
            this.css);
    ...
    addEvent: function(a, b, d) {
        a.addEventListener ? a.addEventListener(b,
            d, !1) : a.attachEvent && a.attachEvent("on" + b, d)
    },
    loadEvents: function() {
        this.addEvent(document, "mouseout", function(a) {
            a = a ? a : window.event;
            a.relatedTarget || a.toElement || bioEp.showPopup()
        });
    ...
    setOptions: function(a) {
        ...
        this.html = "undefined" === typeof a.html ? this.html :
            a.html;
